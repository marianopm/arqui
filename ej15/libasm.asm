...
findMaxIndex:
    ...
    ret
;________________________________Función para imprimir parametros ingresados_____________________
printArgs:
    mov ebp, esp
    pushad
    pushf
    ...
    ret
;______________________________Funcion print para pid___________________________________________
print_pid:
    push eax
    push ebx
